package com.tinkoff.store.presentation.person.admin.fragment
...
import com.tinkoff.store.databinding.FragmentAdminBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            textViewQuit.setOnClickListener {
                ...
                findNavController().navigate(R.id.action_adminFragment_to_signInFragment)
            }
            textViewProductsTitle.setOnClickListener {
                findNavController().navigate(R.id.action_adminFragment_to_sellerProductsFragment)
            }
        }
